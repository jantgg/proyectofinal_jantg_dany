...
class Route(db.Model):
    ...
    start_location_text = db.Column(db.String(250), nullable=False)
    end_location_text = db.Column(db.String(250), nullable=False)
...
class Bike(db.Model):
    ...
    ask_1_license = db.Column(db.String(250))
    ask_11_limitable = db.Column(db.String(250))
    ask_2_wheels = db.Column(db.String(250))
    ask_3_surface = db.Column(db.String(250))
    ask_31_surface_offroad = db.Column(db.String(250))
    ask_311_motor_offroad = db.Column(db.String(250))
    ask_32_custom = db.Column(db.String(250))
    ask_321_refrigeration = db.Column(db.String(250))
    ask_4_comodity = db.Column(db.String(250))
    ask_5_style = db.Column(db.String(250))
    ask_6_price = db.Column(db.String(250))
    ask_7_new = db.Column(db.String(250))
    ask_8_response = db.Column(db.String(250))
    ask_9_reliability = db.Column(db.String(250))
    ask_10_power = db.Column(db.String(250))
    ask_11_armor = db.Column(db.String(250))
    photos = db.relationship('Photo')
